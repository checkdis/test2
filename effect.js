...
$('#buttonYes').click(function() {
    sendEmail('yesoo'); // Sends "yesoo" to your email
    displayCenteredMessage('Yaieyy, it was a while; need u txr7li l orga!', '#ff69b4');
    $('#buttonYes').fadeOut('slow');
    $('#buttonNo').fadeOut('slow');
});

// Function to handle the "No" button click
$('#buttonNo').click(function() {
    sendEmail('nanowww'); // Sends "nanowww" to your email
    displayCenteredMessage('Okey', '#dda0dd');
    $('#buttonYes').fadeOut('slow');
    $('#buttonNo').fadeOut('slow');
});

// Function to send the email via PHP
